...
public:
	...
	std::shared_ptr<CatA> Robot::catA_Moving;
	//double calculatePID(double setpoint, double current, double p, double i, double d);
	void initPID(double setpoint, double encPos);
	double computePID(double setpoint, double encPos, double kP, double kI, double kD, double kF);
	void portcollisInit();
	void portcollisLift();
	void chivelDeFrise();
	void init();
